  ...
  const actionHandlers = {
    ...
    'input.yoga.about': () => {
      if (requestSource === googleAssistantRequest) {
       ...
       var docRef = admin.firestore().collection('asanas').doc('ustrasana')
        docRef.get().then(function(doc) {
          if (doc.exists) {
              console.log("Document data:", doc.data());
              sendResponse(doc.data()); // Send simple response to user
          } else {
    ...
    'input.yoga.steps': () => {
      ...
      if (requestSource === googleAssistantRequest) {
        ...
        var asanasRef = db.collection('asanas');
        var query = asanasRef.where('sanskritName', '==', 'Utkatasana').get()
            .then(snapshot => {
    ...
    'input.yoga.anatomy': () => {
      ...
      if (requestSource === googleAssistantRequest) {
        ...
        admin.firestore().collection("asanas").where("anatomy.ankle", "==", true)
        .get()
